...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.video_path = 'C:/Users/Robert/Desktop/Scripts/robshapes2.mp4'
        # self.cap = cv2.VideoCapture(self.video_path)
        self.displayingVideo = False

        # self.predictor_name = "projects/06test_model.dat"
        # self.predictor = dlib.shape_predictor(self.predictor_name)

        #self.project_name = "06test"
        ...
        # self.xml_path = 'projects/06test_source.xml'
